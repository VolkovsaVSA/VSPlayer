...
import UIKit
#endif
public protocol VSParseProtocol {
    func canParse(scanner: Scanner) -> Bool
    func parsePart(scanner: Scanner) -> SubtitlePart?
}

public extension VSOptions {
    static var subtitleParses: [VSParseProtocol] = [AssParse(), VTTParse(), SrtParse()]
}

public extension String {}

public extension VSParseProtocol {
...
public class AssParse: VSParseProtocol {
...
public class VTTParse: VSParseProtocol {
    public func canParse(scanner: Scanner) -> Bool {
...
public class SrtParse: VSParseProtocol {
    public func canParse(scanner: Scanner) -> Bool {
