//
//  VSPictureInPictureController.swift
//  VSPlayer
//
...
@available(tvOS 14.0, *)
public class VSPictureInPictureController: AVPictureInPictureController {
    private static var pipController: VSPictureInPictureController?
    private var originalViewController: UIViewController?
    private var view: VSPlayerLayer?
    ...
    func stop(restoreUserInterface: Bool) {
        ...
        VSPictureInPictureController.pipController = nil
    ...
    func start(view: VSPlayerLayer) {
        ...
        runOnMainThread { [weak self] in
            ...
            if let pre = VSPictureInPictureController.pipController {
        ...
        #endif
        VSPictureInPictureController.pipController = self
    }
