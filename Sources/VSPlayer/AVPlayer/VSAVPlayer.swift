...
public final class VSAVPlayerView: UIView {
...
public class VSAVPlayer {
    ...
    private let playerView = VSAVPlayerView()
    ...
    private lazy var _pipController: Any? = {
        if #available(tvOS 14.0, *) {
            let pip = VSPictureInPictureController(playerLayer: playerView.playerLayer)
            return pip
        } else {
            return nil
        }
...
extension VSAVPlayer: MediaPlayerProtocol {
