...
class MetalRender {
    ...
    static func makePipelineState(fragmentFunction: String, isSphere: Bool = false, bitDepth: Int32 = 8) -> MTLRenderPipelineState {
        ...
        descriptor.colorAttachments[0].pixelFormat = VSOptions.colorPixelFormat(bitDepth: bitDepth)
    ...
    static func texture(pixelBuffer: CVPixelBuffer) -> [MTLTexture] {
        ...
        let formats = VSOptions.pixelFormat(planeCount: pixelBuffer.planeCount, bitDepth: pixelBuffer.bitDepth)
